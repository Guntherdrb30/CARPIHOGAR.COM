...
const navItems = [
  ...
  { name: 'Mis Disenos de Cocina', href: '/dashboard/cliente/cocinas', icon: 'Kitchen' },
...
const icons: { [key: string]: React.ReactNode } = {
  ...
  Kitchen: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M3 3a1 1 0 011-1h5a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V3zm2 1v12h3V4H5zm7-1a1 1 0 011-1h3a1 1 0 011 1v6h-5V3zm0 8h5v6a1 1 0 01-1 1h-3a1 1 0 01-1-1v-6z" /></svg>,
